...
import { Search, Settings, Upload, ExternalLink, HelpCircle, AlertTriangle, ChevronDown, ArrowUpDown } from 'lucide-react';
...
const GirlSiteUpdatePage: React.FC = () => {
  ...
  const sitesData: SiteData[] = [
    { id: '1', name: 'KFJ京都風俗情報', count: 120, lastUpdated: '2025/12/01 4:58' },
    { id: '2', name: 'シティヘブンネット', count: 279, lastUpdated: '2025/12/01 4:58' },
    { id: '3', name: 'デリヘルタウン', count: 285, lastUpdated: '2025/12/01 4:58' },
    { id: '4', name: 'ぴゅあらば', count: 285, lastUpdated: '2025/12/01 4:59' },
    { id: '5', name: 'マンゾクネット', count: 285, lastUpdated: '2025/12/01 4:58' },
    { id: '6', name: '駅ちか人気！風俗ランキング', count: 199, lastUpdated: '2025/12/01 4:58' },
    { id: '7', name: '口コミ風俗情報局(プランによる)', count: 279, lastUpdated: '2025/12/01 4:58' },
  ];
  ...
  return (
    <div className="h-[calc(100vh-48px)] bg-[#f5f5f5] flex flex-col overflow-hidden">
      ...
      <div className="p-4 md:p-5 bg-[#f5f5f5]">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-[#E67E22]">女性名は変更できませんのでご注意ください。</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 flex-1 overflow-hidden">
            ...
            <div className="p-5 border-b lg:border-b-0 lg:border-r border-gray-200 flex flex-col overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-[15px] font-bold text-[#1976D2]">どの女性を更新しますか？</h2>
              ...
              <div className="flex items-center justify-between mb-4 gap-4">
                <div className="relative flex-1 max-w-[320px]">
                  ...
                  <input
                    ...
                    className="w-full py-2.5 pl-10 pr-4 border border-[#e0e0e0] rounded-full text-sm outline-none focus:border-[#1976D2] bg-[#fafafa] text-[#333] placeholder-[#999]"
                  />
                </div>
                <span className="text-sm text-[#666] whitespace-nowrap">
                  選択中 {selectedGirls.length} / 285人中
                </span>
              </div>
              ...
              <div className="flex items-center gap-3 py-2.5 px-1 border-b border-[#e0e0e0]">
                ...
                <span className="text-sm text-[#666] flex-1">名前</span>
            ...
            <div className="p-5 bg-[#ffebee] flex flex-col overflow-hidden">
              {/* Panel Header */}
              <div className="mb-4">
                <h2 className="text-[15px] font-bold text-[#1976D2]">どのサイトに更新しますか？</h2>
              </div>
              ...
              <div className="flex items-center justify-between mb-4 gap-4">
                <div className="relative flex-1 max-w-[320px]">
                  ...
                  <input
                    ...
                    className="w-full py-2.5 pl-10 pr-4 border border-[#e0e0e0] rounded-full text-sm outline-none focus:border-[#1976D2] bg-white text-[#333] placeholder-[#999]"
                  />
                </div>
                <span className="text-sm text-[#666] whitespace-nowrap">
              ...
              <div className="flex items-center justify-between py-2.5 px-1 border-b border-[#e0e0e0]">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-[#1976D2] cursor-pointer hover:underline">サイト名</span>
              ...
              <div className="flex-1 overflow-y-auto card-scroll">
                {sitesData.map((site) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <span className="text-sm text-[#666]">{site.count} 人</span>
      ...
      {/* Footer Status Bar */}
      <div
        className={`fixed bottom-0 right-0 bg-[#e0e0e0] border-t border-[#ccc] text-[#333] py-3 px-4 md:px-6 flex items-center justify-between z-40 transition-all duration-200 left-0 ${
          isCollapsed ? 'md:left-[60px]' : 'md:left-[220px]'
        }`}
      >
        <div className="flex items-center gap-2">
          <span className="text-sm text-[#333]">オートシンクロ：設定なし</span>
          <HelpCircle size={14} className="text-[#2196F3] cursor-pointer" />
        </div>

        <button className="flex items-center gap-2 text-sm text-[#1976D2] hover:text-[#1565C0] transition-colors cursor-pointer bg-transparent border-none">
          <Settings size={16} />
          オートシンクロを設定する
        </button>
      </div>
...
export default GirlSiteUpdatePage;
